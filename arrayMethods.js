...
const postTaxPrices = prices.map(preTax => preTax * 1.07);
console.log(postTaxPrices);

// OR

// const postTaxPrices = prices.map(function(preTax) {
//   return console.log(preTax * 1.07)
// })
...
// CODE HERE
const totalPopulation = populations.reduce((popNums, currentTotal) => popNums + currentTotal)
...
// CODE HERE
const taxedOrders = orders.map(function(order){
...
console.log(`Bob's total purchases add up to ${bobsTotal}`);