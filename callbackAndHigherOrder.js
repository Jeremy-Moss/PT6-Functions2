...
uniq(names, uniqArray => console.log(`The new names array with all of the duplicate items removed is ${uniqArray}`))
...
// CODE HERE
const addSixtySix = (addingFactory(66));

console.log(addSixtySix(66));